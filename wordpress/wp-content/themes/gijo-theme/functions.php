...
function project_files() {
	wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyDWWrd-neY3nJ76pGsQoJYa7V-9rUOj-pA', NULL, microtime(), true);
	wp_enqueue_script('googleMap_js', get_theme_file_uri('/js/modules/GoogleMap.js'), array('jquery'), microtime(), true);
	...
	wp_enqueue_style('icon_font_awesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', NULL, microtime());
	wp_enqueue_style('university_main_style', get_stylesheet_uri());
}
add_action ('wp_enqueue_scripts', 'project_files');

function university_features() {
	register_nav_menu('headerNavLocation', 'Header Navigation Location');
...
function universityMapKey ($api) {
	$api['key'] = 'AIzaSyDWWrd-neY3nJ76pGsQoJYa7V-9rUOj-pA';
	return $api;
}
